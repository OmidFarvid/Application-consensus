                    ...
                    <div class="modal-body">
                        <form>
                            <div class="row row-no-padding">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="file" ref="fileUploadRef" id="fileUpload" @change="onFileChange">
                                </div>
                            </div>
                            <div class="row row-no-padding" v-show="this.fileLoaded">
                                <div id="dvCSV"></div>
                            </div>
                        </form>
                    </div>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                applicationFields: [
                    {name: "First Name", index: 1, selected: false},
                    {name: "Last Name", index: 2, selected: false},
                    {name: "Age", index: 3, selected: false},
                ...
                if (regex.test(fileUpload.value.toLowerCase())) {
                    if (typeof (FileReader) !== "undefined") {
                        ...
                        reader.onload = function (e) {
                            ...
                            let matchedFields = self.applicationFields;
                            ...
                            for (let i = 0; i < cellsCount; i++) {
                                ...
                                matchedFields.forEach(function (field) {
                        ...
                        self.notifyError("This browser does not support HTML5.");
                    }
                } else {
                    self.notifyError("Please upload a valid CSV file.");
                }
            },
        },
    }
